...
class AttendanceApp(BaseWindow):
    ...
    def login_page(self):
        ...
        self.username_entry.setInputMethodHints(Qt.ImhLowercaseOnly)  # Prevent capitalization
        ...
        self.password_entry.setInputMethodHints(Qt.ImhLowercaseOnly)  # Prevent capitalization
    ...
    def validate_login(self):
        ...
        try:
            ...
            doc_ref = db.collection("a").document("a")
            doc = doc_ref.get()
            if doc.exists:
                stored_password = doc.to_dict().get("password", "")
                if username == "a" and password == stored_password:
    ...
    def show_chatbot_page(self):
        ...
        """)
        back_button.clicked.connect(self.confirm_back_to_login)
    ...
    def get_chatbot_response(self, user_input):
        ...
        if user_input:
            if "legal" in user_input.lower():
                response = "The term **legal** refers to anything related to the law, regulations, and the judicial system. The term **legal** refers to anything related to the law, regulations, and the judicial system. It encompasses rules established by authorities to govern conduct, resolve disputes, and ensure justice. Legal matters include contracts, property rights, criminal offenses, and civil litigation. Lawyers, judges, and lawmakers interpret and enforce legal principles. Legal frameworks vary across countries, influenced by constitutions, statutes, and precedents. Compliance with legal standards is essential for businesses, governments, and individuals. Legal disputes often require court proceedings, mediation, or arbitration. Understanding legal rights and obligations helps individuals protect their interests and naThe term **legal** refers to anything related to the law, regulations, and the judicial system. It encompasses rules established by authorities to govern conduct, resolve disputes, and ensure justice. Legal matters include contracts, property rights, criminal offenses, and civil litigation. Lawyers, judges, and lawmakers interpret and enforce legal principles. Legal frameworks vary across countries, influenced by constitutions, statutes, and precedents. Compliance with legal standards is essential for businesses, governments, and individuals. Legal disputes often require court proceedings, mediation, or arbitration. Understanding legal rights and obligations helps individuals protect their interests and navThe term **legal** refers to anything related to the law, regulations, and the judicial system. It encompasses rules established by authorities to govern conduct, resolve disputes, and ensure justice. Legal matters include contracts, property rights, criminal offenses, and civil litigation. Lawyers, judges, and lawmakers interpret and enforce legal principles. Legal frameworks vary across countries, influenced by constitutions, statutes, and precedents. Compliance with legal standards is essential for businesses, governments, and individuals. Legal disputes often require court proceedings, mediation, or arbitration. Understanding legal rights and obligations helps individuals protect their interests and navigate complex legal issues effectively in society.igate complex legal issues effectively in society.vigate complex legal issues effectively in society.It encompasses rules established by authorities to govern conduct, resolve disputes, and ensure justice. Legal matters include contracts, property rights, criminal offenses, and civil litigation. Lawyers, judges, and lawmakers interpret and enforce legal principles. Legal frameworks vary across countries, influenced by constitutions, statutes, and precedents. Compliance with legal standards is essential for businesses, governments, and individuals. Legal disputes often require court proceedings, mediation, or arbitration. Understanding legal rights and obligations helps individuals protect their interests and navigate complex legal issues effectively in society."
